...
.provider '$builder', ->
    ...
    # forms
    #   widget builder mode: `fb-builder` you could drag and drop to build the form.
    #   widget form mode: `fb-form` this is the form for the end-user to input values for each widget.
    @forms =
        default: []
